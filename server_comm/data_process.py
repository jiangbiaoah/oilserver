...
def decode_binary_data(data):
    ...
    logging.debug("收集到的电流  当前电流：{}, 上冲程电流：{}, 下冲程电流：{}"
                  .format(nowcurrent_rec, upcurrent_rec, lowcurrent_rec))
    ...
    # import numpy as np
    #
    # x = [267.0431373, 263.027451, 259.0117647, 254.9960784, 250.9803922, 244.9568627, 242.9490196, 238.9333333,
    #      232.9098039, 230.9019608, 224.8784314, 222.8705882, 218.854902, 212.8313725, 210.8235294, 206.8078431,
    #      202.7921569,  194.7607843, 190.745098, 188.7372549, 184.7215686, 180.7058824, 176.6901961, 170.6666667,
    #      166.6509804, 162.6352941,  158.6196078, 154.6039216, 150.5882353, 144.5647059, 142.5568627, 136.5333333,
    #      132.5176471, 128.5019608, 124.4862745, 120.4705882, 116.454902, 112.4392157, 108.4235294, 104.4078431,
    #      100.3921569, 96.37647059, 90.35294118,  88.34509804, 82.32156863, 78.30588235, 74.29019608, 70.2745098,
    #      66.25882353, 62.24313725, 58.22745098, 54.21176471, 50.19607843, 46.18039216, 42.16470588, 38.14901961,
    #      34.13333333, 28.10980392, 24.09411765, 20.07843137, 16.0627451,  12.04705882, 8.031372549, 4.015686275,
    #      0, -0.5]
    # y = [40, 39.375, 38.75, 38.125, 37.5, 36.875, 36.25, 35.625, 35, 34.375, 33.75, 33.125, 32.5, 31.875, 31.25,
    #      30.625, 30, 29.375, 28.75, 28.125, 27.5, 26.875, 26.25, 25.625, 25, 24.375, 23.75, 23.125, 22.5, 21.875,
    #      21.25, 20.625, 20, 19.375, 18.75, 18.125, 17.5, 16.875, 16.25, 15.625, 15, 14.375, 13.75, 13.125, 12.5,
    #      11.875, 11.25, 10.625, 10, 9.375, 8.75, 8.125, 7.5, 6.875, 6.25, 5.625, 5, 4.375, 3.75, 3.125, 2.5, 1.875,
    #      1.25, 0.625, 0, 0]
    #
    # p = np.polyfit(x, y, 3)
    # print("p = {}".format(p))
